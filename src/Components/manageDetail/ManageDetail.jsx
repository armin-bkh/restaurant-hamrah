...
const manageDetail = () => {
  return (
    <main className={`text-black min-h-screen flex justify-evenly p-5 flex-col md:flex-row md:items-center flex-wrap`}>
        <article className={`bg-gray-500 p-5 rounded-lg relative boxShadow bgLightTop h-1/5 ${styles.boxContainer}`}>
          <h1 className={`mb-5 Casablanca text-xl lg:text-3xl`}>میز ها</h1>
          ...
          <h2 className={`absolute bottom-10 left-2 transform -rotate-90 
           Casablanca z-10 opacity-70 transition duration-500 ${styles.textMute}`}>میز ها</h2>
        </article>
        <article className={`bg-gray-500 p-5 rounded-lg relative boxShadow bgLightTop h-1/5 ${styles.boxContainer}`}>
          <h1 className={`mb-5 Casablanca text-xl lg:text-3xl`}>غذا</h1>
          <p className={`z-20 Dirooz text-sm lg:text-lg`}>
          ...
          <h2 className={`absolute bottom-10 left-2 transform -rotate-90 
           Casablanca z-10 opacity-70 transition duration-500 ${styles.textMute}`}>غذا</h2>
        </article>
    </main>
  );
};
